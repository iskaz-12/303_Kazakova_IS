...
<head>
    ...
    <title>Обновление данных о мастере</title>
</head>

<body>
    <form method="post" enctype="application/x-www-form-urlencoded" action="help_update.php">

        <?php
            $w_id = $_GET['id'];
            $surname_old = $_GET['surname'];
            $name_old = $_GET['name'];
            $patronymic_old = $_GET['patronymic'];
            $specialization_old = $_GET['specialization'];
        ?>

        <input type="hidden" name="w_id" value=<?=$w_id?>>
        <input type="hidden" name="surname_old" value=<?=$surname_old?>>
        <input type="hidden" name="name_old" value=<?=$name_old?>>
        <input type="hidden" name="patronymic_old" value=<?=$patronymic_old?>>
        <input type="hidden" name="specialization_old" value=<?=$specialization_old?>>

        <fieldset>
            <legend> Личная информация о мастере </legend>
            <p><label>Фамилия: <input name="surname_new"></label></p>
            <p><label>Имя: <input name="name_new"></label></p>
            <p><label>Отчество: <input name="patronymic_new"></label></p>
            
            <!--    Примем, что человек не может поменять свою дату рождения    -->
        ...
        <fieldset>
            ...
            <fieldset>
                ...
                <p><label> <input type="radio" name="specialization_new" value="Автомеханик"> Автомеханик </label></p>
                <p><label> <input type="radio" name="specialization_new" value="Автоэлектрик"> Автоэлектрик </label></p>
                <p><label> <input type="radio" name="specialization_new" value="Мастер кузовного ремонта"> Мастер кузовного ремонта </label></p>
                <p><label> <input type="radio" name="specialization_new" value="Автомаляр"> Автомаляр </label></p>
                <p><label> <input type="radio" name="specialization_new" value="Автожестянщик"> Автожестянщик </label></p>
            </fieldset>
